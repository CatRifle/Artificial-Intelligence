# -*- coding: utf-8 -*-
"""
Created on Fri Feb 21 20:14:31 2020
...
modified_train = np.array(modify_sentence(sen_train))
modified_test = np.array(modify_sentence(sen_test))
...
# train the DT model
Len = int(0.01*len(sen_train))
classifier = tree.DecisionTreeClassifier(min_samples_leaf= Len, random_state=0, criterion='entropy')
